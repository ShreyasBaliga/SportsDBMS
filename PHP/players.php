...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($name_err) && empty($age_err) && empty($sex_err)){
        ...
        if($stmt = $mysqli->prepare($sql)){
            ...
            $stmt->bind_param("ssss", $param_name, $param_age, $param_sex, $param_id);
            
            // Set parameters
            $param_name = $player_name;
            $param_age = $player_age;
            $param_sex = $player_sex;
            $param_id = "CB4";
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group <?php echo (!empty($age_err)) ? 'has-error' : ''; ?>">
                            <label>Age</label>
                            <input type="text" name="player_age" class="form-control" value="<?php echo $player_age; ?>">
                            <span class="help-block"><?php echo $age_err;?></span>
                        </div>
                        <div class="form-group <?php echo (!empty($sex_err)) ? 'has-error' : ''; ?>">
                            <label>Sex</label>
                            <input type="text" name="player_sex" class="form-control" value="<?php echo $player_sex; ?>">
